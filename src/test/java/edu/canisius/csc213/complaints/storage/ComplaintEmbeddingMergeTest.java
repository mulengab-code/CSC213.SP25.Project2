...
public class ComplaintEmbeddingMergeTest {
    ...
    public void testEmbeddingMergeByComplaintId() throws Exception {
        ...
        InputStream csvStream = new FileInputStream(ResourceUtils.getFile("classpath:complaints_sample_1_30.csv"));
        ...
        InputStream jsonlStream = new FileInputStream(ResourceUtils.getFile("classpath:embeddings_sample_1_30.jsonl"));
